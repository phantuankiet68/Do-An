...
<link rel="stylesheet" href="{{asset('public/back-end/css/style-responsive.css')}}" >
<link rel="stylesheet" href="{{asset('public/back-end/css/font-awesome.css')}}" >
<link rel="stylesheet" href="{{asset('public/back-end/css/font.css')}}" >
<link rel="stylesheet" href="{{asset('public/back-end/css/morris.css')}}" >
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <img alt="" src="{{asset('public/back-end/image/kiet.jpg')}}">
                <span class="username">
                <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/list-category')}}">Danh mục thành viên</a></li>
                        <li><a href="{{URL::to('/list-user')}}">Danh sách</a></li>
                    </ul>
                </li> 
                 <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="{{URL::to('/list-kindroom')}}">
                                Danh mục Phòng
                            </a>
                        </li>
                        <li>
                            <a href="{{URL::to('/list-local')}}">
                                Vị trí
                            </a>
                        </li>
                        <li>
                            <a href="glyphicon.html">
                                Danh sách
                            </a>
                        </li>
                    </ul>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="category_news.html">Danh mục Tin tức</a></li>
                        <li><a href="glyphicon.html">Danh sách</a></li>
                    </ul>
                </li>  
...
<script src="{{asset('public/back-end/js/jquery.form-validator.min.js')}}"></script>
 <script>
...
<!-- calendar -->
    <script src="{{asset('public/back-end/js/monthly.js')}}"></script>
